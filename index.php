  ...
  <div class="w3-modal-content w3-card-4 w3-animate-top">
    ...
    <?php 
          if($outputs["mesgroupes"]){
            ...
            echo "<li><h2 style='text-align:center;'>Aucun groupe à afficher!</h2></li>";  
           }
    ?>
    </ul>
    </div>
...
<h2>L'Enicarthage</h2>
<p style='margin-top:50px;'>L'ENICarthage est un établissement d’enseignement supérieur publique ,relevant de l'Université de Carthage, qui s'est transformé en école nationale d'ingénieurs à partir de septembre 2012.
              ...
              <ul class='w3-ul w3-border w3-hover-shadow'>
                <li class='w3-theme'>
                  ...
                  <li>
                    ...
                    <span class='w3-opacity'>étudiants</span>
                  </li>
