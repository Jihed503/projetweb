...
<main role="main">
    ...
    <h5 class="erreur"> <?php/* echo $erreur;*/?></h5>
                ...
                <input style="margin-top:50px;" type="text" id="nom" name="nom" class="form-control" placeholder="saisir un nouveau nom du groupe..." required pattern="INFO[1-3]{1}-[A-E]{1}"
                  title="Pattern INFOX-X. Par Exemple: INFO1-A, INFO2-E, INFO3-C">
                <button style="margin-top:50px;"  type="submit" class="btn btn-warning btn-block" name="modifier">modifier</button>
                </div>
        </form>
    </div>
